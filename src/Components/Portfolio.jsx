      ...
      <main className="bg-white px-5 md:px-20 md:text-1xl lg:px-40 xl:px-60 ">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-20 min-h-screen">
            <div className="md:p-5 md:items-center md:justify-center">
              <h1 className="text-2xl font-medium text-black md:text-4xl">
                Welcome to{" "}
                <span className="text-green-500 md:text-3xl">AnThraX</span>
              </h1>
              <p className="text-md text-gray-800 mb-4 text-wrap py-2 md:text-2xl">
        ...
        <section id="about" className="min-h-screen">
          <div className="max-w-4xl mx-auto pt-20">
            ...
            <div className="flex flex-wrap justify-center gap-10">
              <div className="w-80 bg-gray-100 p-5 rounded-lg shadow-md">
        ...
        <footer className="py-4 sm:items-center">
          <nav className="flex justify-between items-center gap-10">
            <ul className="flex gap-5 text-black text-sm font-medium">
              <li>
